...
const DEFAULT_SETTINGS = {
  ...
  // Per-group accent color + optional emoji/icon, keyed by group name.
  groupMeta: {
    Popular: { color: '#FF6B35', icon: '🔥' },
    Social: { color: '#1877F2', icon: '👥' },
    Entertainment: { color: '#E50914', icon: '🎬' },
    Shopping: { color: '#FF9900', icon: '🛒' },
  },
  groupDisplay: 'grid',
  showBookmarks: false,
  showNotes: false,
...
export { normalizeUrl, faviconFromUrl } from './url.js';
